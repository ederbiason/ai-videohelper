...
export function VideoInputForm({ onVideoUploaded }: VideoInputFormProps) {
    ...
    async function handleUploadVideo(event: FormEvent) {
        ...
        // converter o vídeo em audio para a API da OpenAI (diminui memória)
        ...
        // fazer teste para ver se retorna o id do video
        ...
        >
            ...
            <div className="space-y-2">
                ...
                <Textarea
                    ...
                    placeholder="Inclua palavras-chave mencionadas no vídeos separadas por vírgula (,)"
